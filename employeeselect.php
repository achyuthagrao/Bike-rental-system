...
<h1><a href="employee.php">
        <p align="right"><button>BACK</button></p>
        </a>
<div class  = "main-div">
    <h1><p align="center"><font size="6">LIST OF EMPLOYEES</font></p></h1>
        ...
        <div class = "table-responsive">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="employeeupdate.php?eid=<?php echo $result['EmpId']; ?>">
                     <class = "btn btn-info">UPDATE</a></td>
                     <td><a href="employeedelete.php?eid=<?php echo $result['EmpId']; ?>">
